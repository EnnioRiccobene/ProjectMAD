...
// * @since 1.0.0
// */
//public class GeocoderAutoCompleteView extends androidx.appcompat.widget.AppCompatAutoCompleteTextView {
//
...
//     * @see Geocoding API documentation
//     * @since 1.0.0
//     */
